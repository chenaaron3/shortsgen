...
export function PricingSection({ cancelPath, className }: PricingSectionProps) {
      ...
      <div className="mx-auto max-w-6xl">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            Start free with ${SIGNUP_CREDITS / 100} worth of credits. Upgrade when you need more.
          </p>
          <p className="mt-2 text-sm text-muted-foreground">
            1 video is about 500 credits.
          </p>
        </div>
