...
export const runs = pgTable(t("runs"), {
  ...
  /** Ingest adapter used for URL runs: youtube, reddit, crawl4ai-fallback, etc. */
  source_adapter: text("source_adapter"),
  /** When URL/transcript resolution finished. */
  source_resolved_at: timestamp("source_resolved_at", { mode: "date" }),
...
export const runSchema = createSelectSchema(runs, {
  ...
  source_resolved_at: timestampSchema,
});
