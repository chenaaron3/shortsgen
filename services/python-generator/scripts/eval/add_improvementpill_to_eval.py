...
from path_utils import eval_ui_public, generation_root, project_root
...
def main():
    ...
    ref_dir = generation_root() / "references" / "improvementpill"
    out_path = eval_ui_public() / "eval-dataset.json"
