...
from path_utils import eval_ui_public, project_root

# Import script judge (requires pipeline to be on path)
from pipeline.script_judge import score_script

_ev = eval_ui_public()
ANNOTATIONS_PATH = _ev / "annotations.json"
EVAL_DATASET_PATH = _ev / "eval-dataset.json"
JUDGE_RESULTS_PATH = _ev / "judge-results.json"
